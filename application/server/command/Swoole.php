...
class Swoole extends Command {
    ...
    public function start() {
        ...
        $this->serv->set(array(
            ...
            'log_file' => '/home/wwwroot/default/chatroom/runtime/log_file.'.date("Ym").'.txt',// 'https://wiki.swoole.com/wiki/page/280.html 仅仅是做运行时错误记录，没有长久存储的必要。
